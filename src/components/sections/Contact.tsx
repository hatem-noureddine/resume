        ...
        <AnimatePresence>
            {isVisible && (
                <motion.div
                    ...
                    className="fixed bottom-6 right-6 z-50 bg-emerald-500 text-white px-6 py-4 rounded-xl shadow-lg flex items-center gap-3"
                >
...
export function Contact() {
    ...
    const socialLinks = [
        { icon: GithubIcon, href: "https://github.com/hatemnoureddine", label: "GitHub" },
        { icon: LinkedinIcon, href: "https://linkedin.com/in/hatemnoureddine", label: "LinkedIn" },
